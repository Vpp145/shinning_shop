                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if (!empty($brand['brand_image']))
                                            <a target="_blank"
                                                href="{{ url('front/images/brands/' . $brand['brand_image']) }}">
                                                <img style="width: 50px; margin: 10px;"
                                                    src="{{ asset('front/images/brands/' . $brand['brand_image']) }}">
                                            </a>
                                            <a style="color: #3f6ed3;" class="confirmDelete" title="Delete Brand Image"
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if (!empty($brand['brand_logo']))
                                            <a target="_blank"
                                                href="{{ url('front/images/brands/' . $brand['brand_logo']) }}">
                                                <img style="width: 50px; margin: 10px;"
                                                    src="{{ asset('front/images/brands/' . $brand['brand_logo']) }}">
                                            </a>
                                            <a style="color: #3f6ed3;" class="confirmDelete" title="Delete Brand Logo"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="description" class="form-control" rows="3" placeholder="Enter Brand Description">
...
@endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="meta_title" id="meta_title"
                                            ...
                                            @if (!empty($brand['meta_title'])) value="{{ $brand['meta_title'] }}" @endif>
                                    </div>
                                    <div class="form-group">
                                        <label for="meta_description">Meta Description</label>
                                        <input type="text" class="form-control" name="meta_description"
                                            id="meta_description" placeholder="Enter Meta Description..."
                                            @if (!empty($brand['meta_description'])) value="{{ $brand['meta_description'] }}" @endif>
                                    </div>
                                    <div class="form-group">
                                        <label for="meta_keywords">Meta Keywords</label>
                                        <input type="text" class="form-control" name="meta_keywords"
                                            id="meta_keywords" placeholder="Enter Meta Keywords..."
                                            @if (!empty($brand['meta_keywords'])) value="{{ $brand['meta_keywords'] }}" @endif>
                                    </div>
                                </div>
